...
export default class Element {
  ...
  findElement(selector) {
    return new Promise (async resolve => resolve(await this.parentElement))    
    .then(async el => await el.findElement(By.xpath(selector)));
  };

  findElements(selector) {    
    return new Promise (async resolve => resolve(await this.parentElement))    
    .then(async el => await el.findElements(By.xpath(selector)));
  };
